...
namespace ProtoHSM
{
    public partial class MedicoSearchComboBox : ComboBox
    {
        ...
        private List<MedicoComboDTO> _originalItems = new();
        private bool _filtering;

        public MedicoSearchComboBox()
        {
        ...
        public void LoadItems()
        {
            ...
            _originalItems = ctrl.ObtenerMedicosDTO();

            DisplayMember = nameof(MedicoComboDTO.Nombre);
            ValueMember = nameof(MedicoComboDTO.MedicoID);
        ...
        [Browsable(false)]
        public MedicoComboDTO MedicoSeleccionado
            => SelectedItem as MedicoComboDTO;
